...
namespace Bezier
{
	public class BezierCurve : MonoBehaviour
    {
        ...
        {
			return transform.TransformPoint(BezierCalculator.GetPointQuadratic(points[0].localPosition, 
        ...
        {
			return transform.TransformPoint(BezierCalculator.GetPointQuadratic(positions[0],
	positions[1],
	positions[2], t));
		}
